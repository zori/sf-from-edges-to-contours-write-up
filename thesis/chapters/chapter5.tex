...
perform well in the high-precision, low-recall regime of BPR and are comparatively weaker in the low-precision, high-recall regime \cite{Fowlkes04,Yu2005segmentation}. Hence is not surprising to see in \fref{fig:SE_nnms_sPb-UCM} the shift of the SE+sPb-UCM curve towards better precision at the expense of recall.
