...
\label{Chapter3}
In this chapter we discuss the recent edge detection works by Doll\'ar and Zitnick~\cite{DollarICCV13edges,Dollar2014fast}. They take a data-driven approach to learn semantic edges. % Let the data speak for itself
Their goal is to achieve accurate and fast edge detection. % real-time
